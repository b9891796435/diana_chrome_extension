...
import { getLiveState } from '../../background'
...
class App extends React.Component<{}, { nowLiving: liveType,isGettingLive:boolean }> {
  ...
  LiveNotice = () => {
    if (this.state.nowLiving !== "none" && this.state.nowLiving !== "error") {
      ...
      return (
        <div onClick={this.getLiveStateWrapper} className="retry">
          <img src={require("../../assets/images/idol.png")}/>
  ...
  render(): React.ReactNode {
    return (
      <div className="App">
        <div>
          <img src={memberList.diana.post} alt="" />
        </div>
